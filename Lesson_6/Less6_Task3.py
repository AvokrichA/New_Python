...
class Worker:
    def __init__(self, name, surname, position, wage, bonus):
        self.name = name  # создаем атрибут(self.title) и передаем значение(title)
...
worker_1 = Position('Иван', 'Иванов', 'Менеджер', 50000, 10000)

print(worker_1.position, worker_1.get_full_name(),worker_1.get_total_income())
